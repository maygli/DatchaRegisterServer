...
func (service *ProjectService) getProjectsHandle(w http.ResponseWriter, r *http.Request) {
	...
	projects, err := service.projectRepository.GetOwnerProjects(user.ID)
	if err != nil {
	...
	for _, project := range projects {
		projectData := service.FromProject(project)
